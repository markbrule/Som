  ...
  override def init() = {
    ...
    for {
      ...
      if ((i % 2) == 0) {
        ...
        members(i)(j) = new SomNode(j, i * s60, d, Array.fill[Double](_){scala.util.Random.nextDouble()})
        ...
        members(i)(j) = new SomNode(j + c60, i *s60, d, Array.fill[Double](_){scala.util.Random.nextDouble()})
        if (j > 0) members(i)(j).addNeighbor(members(i)(j-1))
        if (i > 0) members(i)(j).addNeighbor(members(i-1)(j))
